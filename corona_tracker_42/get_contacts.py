...
class Student:
	...
	def get_sessions(self, data):
		...
		Returns:
			infected_sessions: (List[Dict]) contains all sessions of the infected person for the past days.
		"""
...
if __name__ == "__main__":
	...
	person = InfectedStudent("hyilmaz", "www", 3)
	person.get_infected_sessions()
